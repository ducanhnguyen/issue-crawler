...
/**
 * Githublink: Conversations https://github.com/siacs/Conversations <br/>
 * 
...
public class Conversations {
	...
	public static void main(String[] args) {
		Conversations crawler = new Conversations();

		// crawl issue page links
		crawler.crawlIssuePages("https://github.com/siacs/Conversations/issues",
				new File("./crawl_data/Conversations/closed_issue_pages.txt"), "&q=is%3Aissue+is%3Aclosed");
		crawler.crawlIssuePages("https://github.com/siacs/Conversations/issues",
				new File("./crawl_data/Conversations/opening_issue_pages.txt"), "&q=is%3Aopen+is%3Aissue");

		// crawl closed issue links
		IssueLinkCrawler closedIssueCrawler = new ClosedIssueLinksCrawler();
		closedIssueCrawler.setIssuePageLinkFile(new File("./crawl_data/Conversations/closed_issue_pages.txt"));
		closedIssueCrawler.setBaseIssueLinkPath("https://github.com");
		closedIssueCrawler.setIssueLinksFile(new File("./crawl_data/Conversations/closed_issue_links.txt"));
		closedIssueCrawler.crawl();

		// crawl opening issue links
		IssueLinkCrawler openingIssueCrawler = new ClosedIssueLinksCrawler();
		openingIssueCrawler.setIssuePageLinkFile(new File("./crawl_data/Conversations/opening_issue_pages.txt"));
		openingIssueCrawler.setBaseIssueLinkPath("https://github.com");
		openingIssueCrawler.setIssueLinksFile(new File("./crawl_data/Conversations/opening_issue_links.txt"));
		openingIssueCrawler.crawl();

		// crawl closed issue content
		ContentCrawler contentCrawler = new ClosedIssueContentCrawler();
		contentCrawler.setLinksFile(new File("./crawl_data/Conversations/closed_issue_links.txt"));
		contentCrawler.setOutputFolder(new File("./crawl_data/Conversations/closed_issues"));
		contentCrawler.crawl();

		// crawl opening issue content
		ContentCrawler contentCrawler2 = new OpeningIssueContentCrawler();
		contentCrawler2.setLinksFile(new File("./crawl_data/Conversations/opening_issue_links.txt"));
		contentCrawler2.setOutputFolder(new File("./crawl_data/Conversations/opening_issues"));
		...
		closedFilter.setOutputCsvFile(new File("./crawl_data/Conversations/api.csv"));
		...
		openingFilter.setOutputCsvFile(new File("./crawl_data/Conversations/api.csv"));
