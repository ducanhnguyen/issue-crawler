...
/**
 * Githublink: connectbot https://github.com/connectbot/connectbot <br/>
 * 
...
public class connectbot {
	...
	public static void main(String[] args) {
		connectbot crawler = new connectbot();

		// crawl issue page links
		crawler.crawlIssuePages("https://github.com/connectbot/connectbot/issues",
				new File("./crawl_data/connectbot/closed_issue_pages.txt"), "&q=is%3Aissue+is%3Aclosed");
		crawler.crawlIssuePages("https://github.com/connectbot/connectbot/issues",
				new File("./crawl_data/connectbot/opening_issue_pages.txt"), "&q=is%3Aopen+is%3Aissue");

		// crawl closed issue links
		IssueLinkCrawler closedIssueCrawler = new ClosedIssueLinksCrawler();
		closedIssueCrawler.setIssuePageLinkFile(new File("./crawl_data/connectbot/closed_issue_pages.txt"));
		closedIssueCrawler.setBaseIssueLinkPath("https://github.com");
		closedIssueCrawler.setIssueLinksFile(new File("./crawl_data/connectbot/closed_issue_links.txt"));
		closedIssueCrawler.crawl();

		// crawl opening issue links
		IssueLinkCrawler openingIssueCrawler = new ClosedIssueLinksCrawler();
		openingIssueCrawler.setIssuePageLinkFile(new File("./crawl_data/connectbot/opening_issue_pages.txt"));
		openingIssueCrawler.setBaseIssueLinkPath("https://github.com");
		openingIssueCrawler.setIssueLinksFile(new File("./crawl_data/connectbot/opening_issue_links.txt"));
		openingIssueCrawler.crawl();

		// crawl closed issue content
		ContentCrawler contentCrawler = new ClosedIssueContentCrawler();
		contentCrawler.setLinksFile(new File("./crawl_data/connectbot/closed_issue_links.txt"));
		contentCrawler.setOutputFolder(new File("./crawl_data/connectbot/closed_issues"));
		contentCrawler.crawl();

		// crawl opening issue content
		ContentCrawler contentCrawler2 = new OpeningIssueContentCrawler();
		contentCrawler2.setLinksFile(new File("./crawl_data/connectbot/opening_issue_links.txt"));
		contentCrawler2.setOutputFolder(new File("./crawl_data/connectbot/opening_issues"));
		...
		closedFilter.setOutputCsvFile(new File("./crawl_data/connectbot/api.csv"));
		...
		openingFilter.setOutputCsvFile(new File("./crawl_data/connectbot/api.csv"));
